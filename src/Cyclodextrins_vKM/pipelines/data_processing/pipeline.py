...
def create_pipeline(**kwargs):
    return Pipeline(
        [
            node(func=ConvertMol, inputs='Butane_xyz', outputs='Molecule1', name='Create_Molecule1'),
            ...
            node(func=ConvertMol, inputs='Propane_xyz', outputs='Molecule2', name='Create_Molecule2'),
