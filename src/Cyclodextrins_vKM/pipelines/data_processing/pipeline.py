...
def create_pipeline(**kwargs):
    return Pipeline(
        [
            node(func=ConvertMol1, inputs='Butane_xyz', outputs='Molecule1', name='Create_Molecule1'),
            ...
            node(func=ConvertMol2, inputs='Propane_xyz', outputs='Molecule2', name='Create_Molecule2'),
